...
public class GameView extends AppCompatImageView implements TimerListener
{
    ...
    public GameView(Context context)
    {
        ...
        //instantiate singleton timer object
        ...
        int gameType = SettingsActivity.getGameType(context);

        if(gameType == 1)
        {
            //counting game
            gameStyle = new CountingGame(9);
        }
        else if(gameType == 2)
        {
            //flower game
            gameStyle = new FlowerGame();
        }
        else if(gameType == 3)
        {
            //alphabet game
            gameStyle = new AlphabetGame();
        }
        else if(gameType == 4)
        {
            //hawaii game
            gameStyle = new HawaiiGame();
        }
        else      //game type = 5
        {
            //plant game
            gameStyle = new PlantGame();
        }
